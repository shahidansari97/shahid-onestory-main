...
export default function Edit({ auth, data, variants }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Donate Page</h2>}
        >
                ...
                <Form className="flex flex-col p-5 gap-[24px] box box--stacked" onSubmit={handleSubmit}>
                    <Group title="General Information">
                        ...
                        <div className="block sm:flex items-center group form-inline">
                            <InputLabel>Paragraph Text</InputLabel>
                            <Textarea
                                name="paragraph"
                    ...
                    <Group title="Choose Donation Subject">
                        <Select
                            name="variant_id"
