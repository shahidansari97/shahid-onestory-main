...
export default function Edit({ auth, poll, allVariants }) {
    const [formData, setFormData] = useState({
        statement: poll?.statement || '',
        lifetime_ends_in: poll?.lifetime_ends_in || '',
        variants: poll?.variants.map(variant => variant.id) || [],
    });
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route('admin.poll.update', { pollId: poll.id }), form, {
            headers: {
    ...
    return (
        <AuthenticatedLayout>
            <Wrapper title='Edit Poll' message={message}>
