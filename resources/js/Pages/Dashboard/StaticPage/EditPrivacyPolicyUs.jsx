...
export default function EditPrivacyPolicy({ auth, data }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route('admin.privacy-policy.us.update'), formData);
    };

    return (
        <AuthenticatedLayout>
            <Wrapper title=' Privacy Policy US Edit' message={message}>
