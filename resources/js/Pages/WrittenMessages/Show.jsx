...
export default function Show({ writtenMessage }) {
    const author = useMemo(() => writtenMessage?.user, [writtenMessage]);
            ...
            <div className="os-container py-10">
                <div className="mx-auto max-w-[760px] rounded-2xl bg-white shadow-[0_8px_24px_rgba(15,23,42,0.12)] p-6">
                    ...
                    <div className="mt-6 flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>{writtenMessage?.comments_count ?? 0}</span>
                        <span>comments</span>
                    </div>
