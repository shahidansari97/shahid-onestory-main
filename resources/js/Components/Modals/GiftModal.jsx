...
export default function GiftModal({ gifts, user, modalData, activeCardIndex, handleGiftClick, sendGift, error, setError, loading, validationCode, setValidationCode, openModal, serverError }) {
                ...
                <div className="os-gift-modal__cards">
                    {gifts.map((item, index) => (
                        ...
                        >
                            ...
                            <span>$ {(item.cost / 50).toFixed(2)}</span>
                            <div>
