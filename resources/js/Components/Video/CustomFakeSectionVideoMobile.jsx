...
export default function CustomFakeSectionVideoMobile({ src, poster ,classNames }) {
  ...
  return (
    <div
      className="mobile_fake_video  relative bottom-[120px] mx-4 "
    ...
    >
      <video
        ref={videoRef}
        className={` bottom-0  object-cover rounded-2xl opacity-100  block`}
        playsInline
        autoPlay
        loop
        muted={isMuted}
      ...
      <div
        className={`absolute w-[100%] rounded-bl-2xl rounded-br-2xl bottom-[0px] right-0 bg-black/60 px-4 py-2 flex items-center gap-4 text-white text-sm transition-opacity duration-300 ${
