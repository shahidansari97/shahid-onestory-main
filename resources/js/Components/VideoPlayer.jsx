...
const VideoPlayer = ({src, type = 'story', height = 750, showStoryteller = true}) => {
    ...
    return (
        <div className="os-video__player">
            <div className="os-video__panel">
                {(type === 'movie' && showStoryteller) ? (
                    <div className="os-video__storyteller">
                        <Img src="/img/ava-2.png" alt="Profile" className="os-video__storytellr-photo"/>
                        <div className="os-video__storyteller-info">
                            ...
                            <Button tag='a' className="os-btn--p-s" href={currentLink}>Contact Storyteller</Button>
                        </div>
                    </div>
                ) : ''}

                <video ref={videoRef} className={'os-video__iframe os-video__iframe--' + height} controls={false} preload="metadata">
            ...
            {(type === 'story') ? (
                <div className="os-video__storyteller os-video__storyteller--static">
                    <Img src="/img/ava-2.png" alt="Profile" className='os-video__storytellr-photo'/>
                    <div className="os-video__storyteller-info">
                        <a href={'/story-desc/1'} className="os-video__storyteller-name">
                            Seraphina Wentworth
                        </a>
                        <div className="os-video__storyteller-desc">
                            Lorem ipsum dolor sit amet consectetur. Viverra et sollicitudin mi neque aliquet varius
                            eget. Mauris venenatis suspendisse massa quis aliquam arcu. Eu ultrices sagittis et
                            egestas
                            ut. Feugiat quisque in duis lectus sit cras viverra duis accumsan.
                        </div>
                    </div>
                    <div className='os-video__storyteller-buttons'>
                    <Button tag='a' className="os-btn--p-s os-btn--fw-bold  os-btn--gap-16" href={currentLink} icon={true} style={'outline'}>
                        <Img src={'/img/icons/contact.svg'} width={32} height={32} className="os-btn__icon os-btn__icon--w-24"/>
                        Contact Storytaller</Button>
                    <Button tag='a'  className="os-btn--p-s os-btn--fw-bold  os-btn--gap-16"  href={currentLink} icon={true}>
                        <Img src={'/img/icons/gift.svg'} width={32} height={32} className="os-btn__icon os-btn__icon--w-24"/>
