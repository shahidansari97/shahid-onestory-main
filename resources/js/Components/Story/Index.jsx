...
import Custum_homepage from '@/Components/Custum_homepage';
import CustomHomeSectionMobile from '@/Components/CustomHomeSectionMobile';
...
import message7 from '../../../img/message7.jfif';




import ck from '../../../img/ck.png';
import dez_tech from '../../../img/dez_tech.png';
import kenya_harlen from '../../../img/kenya_harlen.png';
import ajstayfit from '../../../img/ajstayfit.png';
import moochi from '../../../img/moochi.png';
import itsmonica from '../../../img/itsmonica.png';
import tommynai from '../../../img/tommynai.png';
import otterking from '../../../img/otterking.png';
import denimalcharly from '../../../img/denimalcharly.png';
import kylin from '../../../img/kylin.png';
import renas from '../../../img/renas.png';
import laurya from '../../../img/laurya.png';
import iammark from '../../../img/iammark.png';
import kaoz from '../../../img/kaoz.png';
import maddisin from '../../../img/maddisin.png';
import paull from '../../../img/paull.png';
import idyli from '../../../img/idyli.png';
import poet from '../../../img/poet.png';



import uprising_in_Iran from '../../../img/uprising_in_Iran.png';
import the_Epstein_files from '../../../img/the_Epstein_files.png';
import peace_in_Ukraine from '../../../img//peace_in_Ukraine.png';
...
import { trackSignup, captureUTMParams, trackCreateStoryClick } from '@/Utils/analytics';
...
export default function Home({ data }) {
    ...
    const { hero, stories, about, gifts, audioRecording } = useMemo(() => data, [data]);
    ...
    }, [auth?.user?.id, media, url, router, trackCreateStoryClick]);
    ...
    const cardstories = [
        {
            title: "Uprising in Iran",
            desc: "We stopped pretending fear was normal.",
            image:
                uprising_in_Iran,
            highlight: true,
        },
        {
            title: "The fallout from the Epstein files",
            desc: "Some stories refuse to stay buried.",
            image:
                the_Epstein_files,
        },
        {
            title: "Trading land for peace in Ukraine",
            desc: "You call it land. We call it home.",
            image:
                peace_in_Ukraine,
        },
    ];
                ...
                <div className="w-full max-w-3xl p-6 space-y-5">
                    ...
                    <div>
                        <textarea
                            ...
                            className="w-full h-32 resize-none rounded-xl border border-[#c8a9ef] bg-transparent px-4 py-3 text-[15px] text-gray-700 placeholder:text-gray-400 focus:border-[#c8a9ef] focus:outline-none focus:ring-2 focus:ring-[#c8a9ef]/30"
                        />
                    </div>
                    ...
                    <button
                        ...
                        className="w-full rounded-xl bg-[#b596d8] py-2 text-[14px] font-semibold text-white shadow-md transition-colors duration-200 hover:bg-[#ab89d1] disabled:cursor-not-allowed disabled:opacity-50"
                    >
            ...
            <Head title="Home" />
            {
                uiState.showPreloader ? (
                    ...
                    <GuestLayout displayMenu={true} addContainer={false}>
                            ...
                            <div className="os-story__content addmore-css os-hero-beyond">
                                <div className="os-hero-beyond__card !px-0">
                                    <div className="os-hero-beyond__header">
                                        <h2
                                            className="os-hero-beyond__title os-hero-beyond__strapline text-center max-[991px]:whitespace-nowrap max-[991px]:tracking-normal leading-[1.15] text-[clamp(0.62rem,2.95vw,1rem)] sm:text-[clamp(0.72rem,2.45vw,1.08rem)] min-[992px]:whitespace-normal min-[992px]:text-[34px] lg:text-[40px] px-0"
                                        >
                                    ...
                                    <div className="os-hero-beyond__footer w-full px-3 sm:px-6 md:px-8">
                                        <p className="os-hero-beyond__subtitle os-hero-beyond__footer-copy font-semibold text-gray-700 text-[clamp(0.72rem,2.05vw,1.125rem)] leading-[1.15] mx-auto text-center w-full">

                                            {/* Mobile/tablet (under 992px): exactly two lines, narrower than hero image */}
                                            <span className="block min-[992px]:hidden whitespace-nowrap text-center text-[clamp(6.5px,2.35vw,13px)] tracking-tight">
                                                Share The Stories You Usually Keep To Yourself.
                                            </span>
                                            <span className="block min-[992px]:hidden whitespace-nowrap text-center text-[clamp(6.5px,2.35vw,13px)] tracking-tight mt-1">
                                                <span className="text-[#FFDA79]">Private By Default.</span>{' '}
                                                You Choose What The World Sees
                                            </span>
                                    ...
                                    <div className="stories-text md:block hidden">
                                        <p>OneStoryPlanet is built for the moments people usually keep to themselves. Here, you</p>
                                        <p>don’t have to perform, polish, or pretend. You can share what actually matters to you, at</p>
                                        <p>your pace, in your voice, with people who are here to listen.</p>


                                    </div>
                                    <div className="stories-text md:hidden block">
                                        <p>OneStoryPlanet is built for the moments people usually keep to themselves. Here, you
                                            don’t have to perform, polish, or pretend. You can share what actually matters to you, at
                                            your pace, in your voice, with people who are here to listen.</p>


                                    </div>

                                    <div className="os-hero-beyond__cta-wrap flex flex-col items-center gap-3 mt-3 w-full px-3 sm:px-0">
                                        {auth?.user?.id ? (
                                            <Button
                                                onClick={handleToOpenVideoEditor}
                                                tag="a"
                                                variant="primary"
                                                className="os-btn os-btn--fs-m os-btn--primary inline-flex items-center justify-center font-normal text-[15px] leading-tight px-[18px] py-2 rounded-full w-fit text-center whitespace-nowrap"
                                            >
                                                Share Your First Story
                                            </Button>
                                        ) : (
                                            <Link href={route('login')}>
                                                <a className="os-btn os-btn--fs-m os-btn--primary inline-flex items-center justify-center font-normal text-[15px] leading-tight px-[18px] py-2 rounded-full w-fit text-center whitespace-nowrap">
                                                    Share Your First Story
                                                </a>
                                            </Link>
                                        )}
                                        <Link href={route('stories.allStories')}>
                                            <a className="os-btn os-btn--fs-m os-btn--primary inline-flex items-center justify-center font-normal text-[15px] leading-tight px-[18px] py-2 rounded-full w-fit text-center whitespace-nowrap">All Stories</a>
                                        </Link>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="os-container min-w-0 max-w-full">
                            ...
                            <div className="os-story__content addmore-css os-hero-beyond ">
                                ...
                                <div className="os-hero addmore-css container w-full mx-auto" style={{ paddingTop: '0px' }}>
                                    ...
                                    <div className="os-hero__video">
                                        <CustomVideoPlayer src={homepagevideo} poster={homepagevideoScreenShot} />
                                    </div>
                        ...
                        <section className="os-creator-community">
                            <div className="os-creator-community__inner">
                                <div className="os-creator-community__grid">
                                    ...
                                    <div className="os-creator-community__cell os-creator-community__cell--img">
                                        <img src={creatorImg3} alt="" />
                                    </div>
                                    <div className="os-creator-community__cell os-creator-community__cell--img">
                                        <img src={creatorImg4} alt="" />
                                    </div>
                                </div>
                        ...
                        <div className="os-container">
                            <div className="os-story__content addmore-css os-hero-beyond">
                                {!isMobile ? (
                                    <CustomHomeSectionMobile linkToVideoEditor={handleToOpenVideoEditor} />
                                ) : (
                                    <Custum_homepage linkToVideoEditor={handleToOpenVideoEditor} />
                                )}
                            </div>
                        </div>
