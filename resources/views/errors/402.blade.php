...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="error-container">
            <img src="{{ asset('img/errors/500.png') }}" alt="402 Image" onerror="this.style.display='none'">
            <div class="error-title">402</div>
            <div class="error-subtitle">Payment Required</div>
            <div class="error-message">
                This resource requires a valid payment.<br>
